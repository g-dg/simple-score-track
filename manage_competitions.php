...
echo '<table><thead><tr><th colspan="3">Manage</th><th>Name</th><th>Overall Point Multiplier</th><th></th>';
// echo '<th>Export</th>';
echo '</tr></thead><tbody>';
...
foreach ($competitions as $competition) {
	...
	echo '</td>';
	echo '<td>';
	echo '<a href="manage_teams.php?competition_id=' . htmlescape(urlencode($competition['id'])) . '">Teams</a>';
	echo '</td>';
	echo '<td>';
