...
function template_header($title = null, $header = true)
{
	...
	echo '<body>';
	if ($header) {
		echo '<nav>Welcome, ' . htmlescape($_SESSION['user_name']) . ' | <a href="results.php">Results</a> | <a href="scores_overview.php">Scores Overview</a> | <a href="teams.php">Manage Clubs/Teams</a> | <a href="events.php">Manage Events</a> | <a href="users.php">Manage Users</a> | <a href="import_export.php">Import/Export Data</a> | <a href="logout.php">Log Out</a></nav>';
